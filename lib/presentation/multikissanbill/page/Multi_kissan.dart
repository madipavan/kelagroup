                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: DropdownButton(
                            ...
                            value: value.multikissan[index]["unit"].toString(),
                            onChanged: (String? newValue) {
                              setState(() {
                                value.multikissan[index]["unit"] = newValue!;
                                ...
                                } else if (value.multikissan[index]["unit"] ==
                                    "Carate") {
                                  pativisible[index] = true;
                            ...
                            items: <String>['Loose', 'Carate', 'Panje', 'Box']
                    ...
                    Visibility(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          KgpercentDropdowm(
                              text: "PatiUnit",
                              dropdownval: value.multikissan[index]["patiunit"],
                              onchanged: (String? val) {
                                setState(() {
                                  value.multikissan[index]["patiunit"] = val;
                                });
                              }),
                          WeightContainer(
                              text: "Pati Wt",
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          KgpercentDropdowm(
                              ...
                              onchanged: (String? val) {
                                setState(() {
                                  value.multikissan[index]["dandaunit"] = val;
                                });
                              }),
                          WeightContainer(
                              text: "Danda Wt",
                    ...
                    Visibility(
                      ...
                      child: Row(
                        ...
                        children: [
                          TextwithFeild(
                              controller: value.multikissan[index]["wastage"],
                              text: "Wastage"),
                          KgpercentDropdowm(
                            text: "WastageUnit",
                            onchanged: (String? val) {
                              setState(() {
                                value.multikissan[index]["wastageunit"] = val;
                              });
                            },
                            dropdownval: value.multikissan[index]
                                ["wastageunit"],
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          TextwithFeild(
                              controller: value.multikissan[index]["lungar"],
                              text: "Lungar"),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            "${value.multikissan[index]["kissan_amt"]}₹",
                            style: TextStyle(
                            ...
                            child: Row(
                              children: [
                                ...
                                Tooltip(
                                  message: "Commission",
                                  child: CustomDropdown(
                                    val: kelaGroupcommissionpercentList[index],
                                    onChanged: (val) {
                                      setState(() {
                                        kelaGrouphammalipercentList[index] =
                                            val;
                                ...
                                Tooltip(
                                  ...
                                  child: CustomDropdown(
                                    ...
                                    onChanged: (val) {
                                      setState(() {
                                        kelaGroupmtaxpercentList[index] = val;
                                      });
                                    },
                                    percentlist: <String>[
                                      '1',
                                ...
                                setState(() {
                                  ...
                                  if (isKelagroupvisible[index]) {
                                    value.kelagroupcalc(
                                        index,
                                        kelaGrouphammalipercentList[index],
                                        kelaGroupcommissionpercentList[index],
